...
# -mtune=generic -march=x86-64 -auxbase-strip 101-hello_holberton.asm
...
# 101-hello_holberton.c:11: 	printf("%s\n", "Hello, Holberton");
	leaq	.LC0(%rip), %rdi	#,
	call	puts@PLT	#
# 101-hello_holberton.c:13: 	return (0);
	movl	$0, %eax	#, _3
# 101-hello_holberton.c:14: }
	popq	%rbp	#
	.cfi_def_cfa 7, 8
	ret	
	.cfi_endproc
